        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="mt-auto mb-20">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-[1.1] text-white">
              Start building <br />
              your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2563FF] to-[#00E5FF]">legacy.</span>
            </h1>
            <p className="text-lg text-[var(--text-secondary)] max-w-md leading-relaxed">
              Create an account to join thousands of developers and mentors pushing the boundaries of what's possible.
            </p>
          </div>
        ...
        <div className="w-full max-w-[400px] mx-auto py-12">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-[var(--text-muted)] text-[15px]">
              Join the community of builders and experts.
            </p>
          </div>
          ...
          >
            ...
            <span className="text-[var(--text-primary)]">Sign up with Google</span>
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {(["student", "mentor"] as const).map((r) => (
                  <button
                    ...
                    type="button"
                    onClick={() => setRole(r)}
                    className={`relative py-3 px-4 rounded-xl border text-[15px] font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
                      role === r
                        ? "border-[#2563FF] bg-[#2563FF]/10 text-white"
                        : "border-white/[0.06] bg-[#060A13] text-[var(--text-secondary)] hover:border-white/[0.12]"
                    }`}
                  >
                    <span>{r === "student" ? "🎓" : "👨‍🏫"}</span>
                    <span>{r === "student" ? "Student" : "Mentor"}</span>
                    {role === r && (
                      <svg className="w-4 h-4 absolute right-3 text-[#2563FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex gap-1 flex-1">
                    {[1, 2, 3].map((level) => (
                      <div
                        ...
                        style={{
                          background: passwordStrength >= level ? strengthColors[passwordStrength] : "rgba(255,255,255,0.06)"
                        }}
                      />
                    ))}
                  </div>
            ...
            {/* Terms Agreement */}
            <label className="flex items-start gap-3 cursor-pointer group py-1 mt-2">
              <div className="relative mt-0.5">
                ...
                <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-all duration-200 ${
                  agreed
                    ...
                    : "border-white/[0.15] bg-[#060A13] group-hover:border-white/[0.3]"
                }`}>
                  {agreed && (
              ...
              <span className="text-xs text-[var(--text-muted)] leading-relaxed">
                I agree to the{" "}
                <Link href="#" className="text-white hover:text-[#00E5FF] transition-colors font-medium">Terms of Service</Link>{" "}
                and{" "}
                <Link href="#" className="text-white hover:text-[#00E5FF] transition-colors font-medium">Privacy Policy</Link>
              </span>
            </label>
            ...
            <button
              type="submit"
              disabled={!agreed || isLoading || !fullName || !email || !password}
          ...
          <div className="mt-8 text-center">
            <p className="text-[var(--text-muted)] text-sm">
              ...
              <Link href="/auth/login" className="font-medium text-white hover:text-[#00E5FF] transition-colors">
                Log in
              </Link>
            </p>
          </div>
